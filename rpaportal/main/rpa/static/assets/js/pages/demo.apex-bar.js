var colors = ["#39afd1"],
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#grouped-bar"), options)).render(), ["#727cf5", "#0acf97", "#fa5c7c", "#6c757d", "#39afd1"]),
    ...
    options = {
        ...
        xaxis: {
            ...
            labels: { formatter: function(o) { return o + "K" } },
            axisBorder: { show: !1 }
        },
        yaxis: { title: { text: void 0 } },
        colors: colors = dataColors ? dataColors.split(",") : colors,
        tooltip: { y: { formatter: function(o) { return o + "K" } } },
        fill: { opacity: 1 },
        states: { hover: { filter: "none" } },
        legend: { position: "top", horizontalAlign: "center", offsetY: 10 },
        grid: { borderColor: "#f1f3fa" }
    },
    colors = ((chart = new ApexCharts(document.querySelector("#stacked-bar"), options)).render(), ["#ffbc00", "#39afd1", "#6c757d", "#e3eaef", "#727cf5"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#full-stacked-bar"), options)).render(), ["#fa5c7c","#0acf97"]),
    ...
    options = {
        ...
        series: [
            ...
            { name: "Females", data: [-.8, -1.05, -1.06, -1.18, -1.4, -2.2, -2.85, -3.7, -3.96, -4.22, -4.3, -4.4, -4.1, -4, -4.1, -3.4, -3.1, -2.8] }
        ],
        grid: { borderColor: "#f1f3fa", padding: { bottom: 5 } },
        yaxis: { min: -5, max: 5, title: {} },
        tooltip: {
            shared: !1,
            x: { formatter: function(o) { return o } },
            y: { formatter: function(o) { return Math.abs(o) + "%" } }
        },
        xaxis: {
            categories: ["85+", "80-84", "75-79", "70-74", "65-69", "60-64", "55-59", "50-54", "45-49", "40-44", "35-39", "30-34", "25-29", "20-24", "15-19", "10-14", "5-9", "0-4"],
            title: { text: "Percent" },
            labels: { formatter: function(o) { return Math.abs(Math.round(o)) + "%" } },
            axisBorder: { show: !1 }
        },
        legend: { offsetY: 7 }
    },
    ...
    options = {
        ...
        annotations: {
            xaxis: [{
                ...
                label: { borderColor: colors[1], style: { color: "#fff", background: colors[1] }, text: "X annotation" }
            }],
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#reversed-bar"), options)).render(), ["#727cf5", "#0acf97", "#fa5c7c", "#39afd1"]),
    ...
    options = {
        ...
        yaxis: { title: { text: void 0 } },
        tooltip: { shared: !1, y: { formatter: function(o) { return o + "K" } } },
        colors: colors = dataColors ? dataColors.split(",") : colors,
    ...
    labels = ((chart = new ApexCharts(document.querySelector("#pattern-bar"), options)).render(), Array.apply(null, { length: 39 }).map(function(o, a) { return a + 1 })),
    options = {
        chart: {
            height: 450,
            type: "bar",
        ...
        fill: {
            type: "image",
            opacity: .87,
            image: { src: ["assets/images/small/small-4.jpg"], width: 466, height: 406 }
        }
    },
    colors = ((chart = new ApexCharts(document.querySelector("#image-fill-bar"), options)).render(), ["#727cf5", "#0acf97", "#fa5c7c", "#6c757d", "#39afd1", "#2b908f", "#ffbc00", "#90ee7e", "#f48024", "#212730"]),
    ...
    options = {
        ...
        dataLabels: {
            ...
            textAnchor: "start",
            style: { colors: ["#fff"] },
            formatter: function(o, a) { return a.w.globals.labels[a.dataPointIndex] + ":  " + o },
            offsetX: 0,
        ...
        yaxis: { labels: { show: !1 } },
        grid: { borderColor: "#f1f3fa" },
        tooltip: { theme: "dark", x: { show: !1 }, y: { title: { formatter: function() { return "" } } } }
    },
    dataColors = ((chart = new ApexCharts(document.querySelector("#datalables-bar"), options)).render(), $("#bar-markers").data("colors")),
    options = {
        series: [{
            name: "Actual",
            data: [{ x: "2017", y: 12, goals: [{ name: "Expected", value: 14, strokeWidth: 2, strokeDashArray: 2, strokeColor: (colors = dataColors ? dataColors.split(",") : colors)[1] }] },
        ...
        colors: colors,
        dataLabels: {
            dataLabels: { formatter: function(o, a) { a.w.config.series[a.seriesIndex].data[a.dataPointIndex].goals; return o } }
        },
